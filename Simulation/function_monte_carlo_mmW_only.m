...
function [SE_k, SE_num_m, SE_den_m, HI_UE_rx_m,HI_AP_tr_m] = function_monte_carlo_mmW_only(L,K,K_mmW,N,N_mmW,eta,h_mmW,h_hat_mmW,h,h_hat,K_AP_TR,K_UE_RX,no_of_rea,plos)
