...
% numUE_sub6_arr = 10;
lambda_UE_sub6 = 100:20:200; %[30:20:90, 100]; %100;
...
%                 end                
        ...
        %         load("mobility_data.mat")
                ...
                result_string = strcat('/results_',num2str(numUE),...
                    ...
                    'lambdaUE_',num2str(numBlockers), 'Blockers_randomHeight_', num2str(aID),'Min_rate', num2str(rmin), "Pow_fac", num2str(params.p_fac));
                ...
                output_categories = ['UE idx,','lambdaBS,','lambdaUE,','numBlockers,',...
                    ...
                    'minRatereq,','powerFac,','meanOutageDuration_wo_CF,','outageProbability_wo_CF,','meanOutageDuration,','outageProbability\n'];
...
%                                 saveas(gcf,'cdfplot','png')
        ...
        %                             out_dur_analysis_wo_cf = outage_duration_analysis_wo_cf(ue_idx,idxDiscDelay, idxFailureDetectionDelay, idxConnDelay, idxSignalingAfterRachDelay);                        
                                    ...
                                    fprintf(fileID,formatSpec,ue_idx, lambda_BS(idxBSDensity),lambda_UE_sub6(idxUEDensity),numBlockers,...
                                        ...
                                        signalingAfterRachDelay,frameHopCount,frameDeliveryDelay,...
                                        min_rate_req, p_fac, mean_outage_duration_wo_cf,outage_probability_wo_cf,mean_outage_duration,outage_probability);
                                end
                            end
                        end
                    end
