...
projectdir = 'C:\Users\dsoum\Desktop\data\outageData\outageResultsvaryinglbthres_mmse_updated';
...
writetable(summaryTable,'./outage_mmse_updated.txt')
writetable(summaryTable,'./outage_mmse_updated.csv')
