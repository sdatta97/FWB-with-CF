...
writetable(summaryTable,'./outage_data_lambda_UE_500_lambda_BS_vary_modify_new.txt')
writetable(summaryTable,'./outage_data_lambda_UE_500_lambda_BS_vary_modify_new.csv')