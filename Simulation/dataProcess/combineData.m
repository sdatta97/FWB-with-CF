...
dinfo = dir(fullfile(projectdir, 'results_8UE*.csv'));   %use appropriate extension
...
writetable(summaryTable,'./outage_8UE_multi_UEv2.txt')
writetable(summaryTable,'./outage_8UE_multi_UEv2.csv')