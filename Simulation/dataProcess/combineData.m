...
projectdir = 'C:\Users\dsoum\FWB-with-CF\Simulation\resultData\outageResults';
...
writetable(summaryTable,'./outage_mmse_updated_analysis.txt')
writetable(summaryTable,'./outage_mmse_updated_analysis.csv')
