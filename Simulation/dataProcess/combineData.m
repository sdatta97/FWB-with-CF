...
% projectdir = '/Users/sdatta/Desktop/data/multiUEsqgridBS_varyBSdensity_fix_numUE/outageResults';
...
writetable(summaryTable,'./rate_comparison.txt')
writetable(summaryTable,'./rate_comparison.csv')