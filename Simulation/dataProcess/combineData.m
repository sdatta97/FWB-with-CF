...
writetable(summaryTable,'./outage_mmse_fdm_updated_vary_deploy_range_multi_UEv2.txt')
writetable(summaryTable,'./outage_mmse_fdm_updated_vary_deploy_range_multi_UEv2.csv')