...
% figure
% plot(log10(rho_tot_arr),SE_setback_AP_sharing_UEs); hold on;
% plot(log10(rho_tot_arr),SE_setback_AP_not_sharing_UEs); hold on;
% plot(log10(rho_tot_arr),SE_mmW_UE); hold on;
% figure
