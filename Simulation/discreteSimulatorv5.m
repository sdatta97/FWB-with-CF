...
function simOutputs = discreteSimulatorv5(simInputs) %trying Pei's idea
%% Inputs
                ...
                if isBSRecovered
                    ...
                    if UE.sub6ConnectionState(ue_idx) == 1
                        ...
                        if ((r_calc_sub6(ue_idx) < params.r_min(ue_idx)) || any(r_calc_sub6(1+params.numUE:params.numUE+params.numUE_sub6) < params.r_min_sub6))
                            ...
                            R_GUE = params.R_GUE;
                            h_LOS_GUE = params.h_LOS_GUE;
                            if ((bs_idx>1) && (bs_idx<params.numGNB_sub6))
                                params.R_GUE = R_GUE(:,:,[1:(bs_idx-1), (1+bs_idx):params.numGNB_sub6],:);
                                params.h_LOS_GUE = h_LOS_GUE(:,[1:(bs_idx-1), (1+bs_idx):params.numGNB_sub6],:);
                            elseif (bs_idx == 1)
                                params.R_GUE = R_GUE(:,:,2:params.numGNB_sub6,:);
                                params.h_LOS_GUE = h_LOS_GUE(:,2:params.numGNB_sub6,:);
                            elseif (bs_idx == params.numGNB_sub6-1)
                                params.R_GUE = R_GUE(:,:,1:params.numGNB_sub6-1,:);
                                params.h_LOS_GUE = h_LOS_GUE(:,1:params.numGNB_sub6-1,:);  
                            end
                            n_sub6 = params.numGNB_sub6;
                            params.numGNB_sub6 = n_sub6-1;
                            ...
                            params.numGNB_sub6 = numGNB_sub6;
                            params.numUE = numUE;
                            params.Band = Band;
