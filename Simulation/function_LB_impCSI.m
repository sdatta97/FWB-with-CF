function [SE_k7, snr_numerator1, snr_denominator,HI_term_UE_rx1, HI_term_AP_tx1,beamforming,INTERFERENCE_UAV_GUE ] = function_LB_impCSI(K,L,N,eta,h_LOS,R,psi,eta_p,PHI,K_AP_TX,K_UE_RX,gamma, gamma_MAT, beta_actual, beta_actual_MAT,C_ERR,GAMMA_NLOS )
