...
for aID = 0:1:99
    ...
    % numUE_sub6_arr = 10;
    lambda_UE_sub6 = 150; %100:50:200; %[30:20:90, 100]; %100;
    ...
    %         params.numUE_sub6 = poissrnd(lambda_UE_sub6(idxBSDensity)*pi*(params.coverageRange_sub6/1000)^2);
        ...
        %                                    end
                                           ...
                                           user_sc_alloc = ones(numUE+numUE_sub6,num_sc_sub6);                               
                                           user_sc_alloc(ue_idx,2) = 0;
                                           user_sc_alloc(ue_idxs_affected,1) = 0;
                                           params.user_sc_alloc = user_sc_alloc;
                                           params.sub6ConnectionState = zeros(numUE,1);
                                           ...
                                           p_out = CF_outage_analyticalv2(params,ue_idx,lambda_BS(idxBSDensity),lambda_UE_sub6(idxUEDensity));
        ...
        %                                    outage_duration_analysis(k,idxDiscDelay, idxFailureDetectionDelay, idxConnDelay, idxSignalingAfterRachDelay) = outage_probability_analysis(k,idxDiscDelay, idxConnDelay) + tos;
                        ...
                        result_string = strcat('/results_analysis_',num2str(numUE),...
